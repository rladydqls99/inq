...
export function HomePage() {
  ...
  const loadHome = useCallback(async () => {
    ...
    try {
      const response = await apiRequest<ChallengeResponse[]>("/challenges");
      setChallenges(
        response.filter((challenge) => challenge.status === "active"),
      );
    } catch {
      setLoadError(true);
    } finally {
  ...
  if (loadError) {
    return <HomeErrorState onRetry={() => void loadHome()} />;
  }
...
function HomeLoadingState() {
  return (
    ...
    >
      ...
      <div className="home-skeleton home-skeleton--headline" aria-hidden="true" />
...
function HomeErrorState({ onRetry }: { onRetry: () => void }) {
  return (
    <section className="home-page home-state-page" aria-labelledby="home-error-title">
...
function HomeEmptyState() {
  return (
    <section className="home-page home-state-page" aria-labelledby="home-empty-title">
      <div className="home-state">
...
function compareChallenges(left: ChallengeResponse, right: ChallengeResponse) {
  ...
  if (leftTime !== rightTime) {
    return (leftTime ?? Number.POSITIVE_INFINITY) -
  ...
  if (leftCreatedAt !== rightCreatedAt) {
    return (leftCreatedAt ?? Number.POSITIVE_INFINITY) -
