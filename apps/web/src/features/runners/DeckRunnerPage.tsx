...
export function DeckRunnerPage() {
  ...
  const moveToRef = useRef<(nextCursor: number) => Promise<void>>(async () => {});
    ...
    <section className="page">
      ...
      <div className="runner-surface">
        <VehicleControlNotice
          status={
            vehicleControlEnabled ? vehicleControlStatus : "disabled"
          }
        ...
        <CardPlayer
          ...
          initiallyRevealed
          canPrevious={!moving && cursor > 0}
          canNext={!moving && cursor < runState.cards.length}
